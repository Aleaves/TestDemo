...
public class DexElementFuse {
    ...
    public static final String pluginPath = "/storage/emulated/0/Android/data/com.app.pluginapp/cache/plugin-debug.apk";
     ...
     * @throws Exception
     */
    public void loadResource(Context mContext) throws Exception {
